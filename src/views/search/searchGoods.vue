...
<script>
import { hotGoods, getGoodsList, searchGoods, getStyleList, getSpaceList, getCategoryList, getCategoryAndSon } from 'api'
import infiniteScroll from '@/components/infiniteScroll'
import goodScreening from '@/components/screening'
